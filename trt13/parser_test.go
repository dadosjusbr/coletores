...
var (
	...
	expectedIncomeOthers      = storage.Funds{Total: 20, PersonalBenefits: &two, EventualBenefits: &three, PositionOfTrust: &four, Daily: &five, Gratification: &six, OriginPosition: &seven}
