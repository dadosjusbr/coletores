...
def parse(file_names):
    ...
    for fn in file_names:
        ...
        # if 'Pensionistas' in fn and 'membros' in fn:
        #     # Puts all parsed employees in the big map
   
        #     employees.update(parse_employees_pensionistas_membros(fn))

        # if 'Pensionistas' in fn and 'servidores' in fn:
        #     # Puts all parsed employees in the big map
   
        #     employees.update(parse_employees_pensionistas_servidores(fn))
