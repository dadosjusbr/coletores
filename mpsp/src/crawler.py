...
baseURL = (
    "http://www.mpsp.mp.br/portal/page/portal/Portal_da_Transparencia/Contracheque/"
)
            ...
            if beneficiary_types[key] == "Membros_ativos":
                if month in ["01", "02", "03", "04", "05", "06", "07"]:
                    ...
                    link = (
                        baseURL
                        + beneficiary_types[key]
                        + "/Membros%20Ativos%20tabela%201%20ref%20"
                        + month
                        + "-"
                        + year
                        + ".ods"
                ...
                if month in ["01", "02", "03", "04", "05", "06", "07"]:
                    ...
                    link = (
                        baseURL
                        + beneficiary_types[key]
                        + "/Membros%20Inativos%20tabela%201%20ref%20"
                        + month
                        + "-"
                        + year
                        + ".ods"
                ...
                if month in ["01", "02", "03", "04", "05", "06", "07"]:
                    ...
                    link = (
                        baseURL
                        + beneficiary_types[key]
                        + "/Servidores%20Ativos%20tabela%201%20ref%20"
                        + month
                        + "-"
                        + year
                        + ".ods"
                ...
                if month in ["01", "02", "03", "04", "05", "06", "07"]:
                    link = (
                        baseURL
                        + "servidores_inativos/Tabela%20I%20servinat"
                        + month
                        + year
                        + ".ods"
                    )
                ...
                if month == "01":
                    ...
                    link = (
                        ...
                        + "Pensionistas/"
                        + beneficiary_types[key]
                        + "/Benefici%C3%A1rios%20Membros%20"
                        + month
                        + year
                        + ".ods"
                    )
                    ...
                    link = (
                        ...
                        + "Pensionistas/"
                        + beneficiary_types[key]
                        + "/Beneficiarios%20membros%20ref%20"
                        + month
                        + "-"
                        + year
                        + ".ods"
                ...
                if month in ["01", "03", "04", "05"]:
                    link = (
                        ...
                        + "Pensionistas/"
                        + beneficiary_types[key]
                        + "/Benefici%C3%A1rios%20Servidores%20"
                        + month
                        + year
                        + ".ods"
                    )
                    ...
                    link = (
                        ...
                        + "Pensionistas/"
                        + beneficiary_types[key]
                        + "/Beneficiarios%20servidores%20ref%20"
                        + month
                        + "-"
                        + year
                        + ".ods"
            ...
            if beneficiary_types[key] == "Membros_ativos":
                if month in ["01", "02", "03", "04", "05"]:
                    ...
                    link = (
                        baseURL
                        + beneficiary_types[key]
                        + "/Membros%20Ativos%20-%20Tabela%20I%20ref%20"
                        + month
                        + year
                        + ".ods"
                    )
                ...
                if month == "01":
                    link = (
                        baseURL
                        + beneficiary_types[key]
                        + "/Tabela%20I%20membros%20inativos%20ref12-a"
                        + ".ods"
                    )
                    links_type[beneficiary_types[key]] = link
                elif month == "02":
                    link = (
                        baseURL
                        + beneficiary_types[key]
                        + "/Tabela%20I%20membros%20inativos%20ref0119-a"
                        + ".ods"
                    )
                    links_type[beneficiary_types[key]] = link
                elif month in ["03", "04", "05"]:
                    link = (
                        baseURL
                        + beneficiary_types[key]
                        + "/Tabela%20I%20membros%20inativos%20ref"
                        + month
                        + "19.ods"
                    )
                    links_type[beneficiary_types[key]] = link
                    ...
                    link = (
                        baseURL
                        + beneficiary_types[key]
                        + "/Membros%20Inativos%20-%20Tabela%20I%20ref%20"
                        + month
                        + year
                        + ".ods"
                    )
                ...
                if month in ["01", "03"]:
                    link = (
                        baseURL
                        + beneficiary_types[key]
                        + "/Tabela%20I%20%20servidores%20ativos%20ref"
                        + month
                        + "19.ods"
                    )
                    links_type[beneficiary_types[key]] = link
                    ...
                    link = (
                        baseURL
                        + beneficiary_types[key]
                        + "/Tabela%20I%20servidores%20ativos%20ref"
                        + month
                        + "19.ods"
                    )
                    links_type[beneficiary_types[key]] = link
                    ...
                    link = (
                        baseURL
                        + beneficiary_types[key]
                        + "/Servidores%20Ativos%20-%20Tabela%20I%20ref%20"
                        + month
                        + year
                        + ".ods"
                    )
                    ...
                    link = (
                        baseURL
                        + beneficiary_types[key]
                        + "/Servidores%20Ativos%20-%20Tabela%20I%20ref"
                        + month
                        + year
                        + ".ods"
                    )
                ...
                if month in ["01", "02", "03", "04", "05"]:
                    ...
                    link = (
                        baseURL
                        + "servidores_inativos/Servidores%20Inativos%20-%20Tabela%20I%20ref%20"
                        + month
                        + year
                        + ".ods"
                    )
                    ...
                    link = (
                        baseURL
                        + "servidores_inativos/Servidores%20Inativos%20-%20Tabela%20I%20ref"
                        + month
                        + year
                        + ".ods"
                    )
                    ...
                    link = (
                        baseURL
                        + "servidores_inativos/Tabela%20I%20servinat09"
                        + year
                        + "_1.ods"
                    )
                    links_type[beneficiary_types[key]] = link
                ...
                if month == "01":
                    link = (
                        ...
                        + "Pensionistas/"
                        + beneficiary_types[key]
                        + "/Benefici%C3%A1rios%20Membros%20ref%20"
                        + month
                        + "19.ods"
                    )
                    links_type[beneficiary_types[key]] = link
                    ...
                    link = (
                        ...
                        + "Pensionistas/"
                        + beneficiary_types[key]
                        + "/Benefici%C3%A1rios%20do%20Minist%C3%A9rio%20P%C3%BAblico%20Membros%20ref%20"
                        + month
                        + year
                        + ".ods"
                    )
                    ...
                    link = (
                        ...
                        + "Pensionistas/"
                        + beneficiary_types[key]
                        + "/Benefici%C3%A1rios%20Membros%20do%20Minist%C3%A9rio%20P%C3%BAblico%20"
                        + month
                        + year
                        + ".ods"
                    )
                ...
                if month == "01":
                    link = (
                        ...
                        + "Pensionistas/"
                        + beneficiary_types[key]
                        + "/Benefici%C3%A1rios%20Servidores%20ref%20"
                        + month
                        + "19.ods"
                    )
                    links_type[beneficiary_types[key]] = link
                    ...
                    link = (
                        ...
                        + "Pensionistas/"
                        + beneficiary_types[key]
                        + "/Benefici%C3%A1rios%20do%20Minist%C3%A9rio%20P%C3%BAblico%20Servidores%20ref%20"
                        + month
                        + year
                        + ".ods"
                    )
                    ...
                    link = (
                        ...
                        + "Pensionistas/"
                        + beneficiary_types[key]
                        + "/Benefici%C3%A1rios%20Servidores%20do%20Minist%C3%A9rio%20P%C3%BAblico%20"
                        + month
                        + year
                        + ".ods"
                    )
        ...
        for key in beneficiary_types:
            if beneficiary_types[key] == "Membros_ativos":
                if month in ["07", "08"]:
                    link = (
                        baseURL
                        + "verbas_indeniz/verb_ind_mem/verb_ind_mem_ativos/Membros%20Ativos%20-%20Tabela%20III%20ref%20"
                        + month
                        + year
                        + ".ods"
                    )
                    ...
                    link = (
                        baseURL
                        + "verbas_indeniz/verb_ind_mem/verb_ind_mem_ativos/Tabela%20III%20memb"
                        + month
                        + year
                        + ".ods"
                    )
                    ...
                    link = (
                        baseURL
                        + "verbas_indeniz/verb_ind_mem/verb_ind_mem_ativos/Tabela%20III%20memb09"
                        + year
                        + "_1.ods"
                    )
                    links_type[beneficiary_types[key]] = link
                ...
                if month == "07":
                    link = (
                        baseURL
                        + "verbas_indeniz/verb_ind_serv/verb_ind_serv_ativos/Servidores%20Ativos%20-%20Tabela%20III%20ref%20"
                        + month
                        + year
                        + ".ods"
                    )
                    ...
                    link = (
                        baseURL
                        + "verbas_indeniz/verb_ind_serv/verb_ind_serv_ativos/Servidores%20Ativos%20-%20Tabela%20III%20ref"
                        + month
                        + year
                        + ".ods"
                    )
                    ...
                    link = (
                        baseURL
                        + "verbas_indeniz/verb_ind_serv/verb_ind_serv_ativos/Tabela%20III%20serv"
                        + month
                        + year
                        + ".ods"
                    )
                    ...
                    link = (
                        baseURL
                        + "verbas_indeniz/verb_ind_serv/verb_ind_serv_ativos/Tabela%20III%20serv09"
                        + year
                        + "_1.ods"
                    )
                    links_type[beneficiary_types[key]] = link
        ...
        for key in beneficiary_types:
            if beneficiary_types[key] == "Membros_ativos":
                if month in ["01", "02", "03", "04", "05", "06", "07"]:
                    ...
                    link = (
                        baseURL
                        + "verbas_indeniz/verb_ind_mem/verb_ind_mem_ativos/Membros%20Ativos%20tabela%203%20ref%20"
                        + month
                        + "-"
                        + year
                        + ".ods"
                ...
                if month in ["08", "09", "12"]:
                    ...
                    link = (
                        baseURL
                        + "verbas_indeniz/verb_ind_mem/verb_ind_mem_inativos/Membros%20Inativos%20tabela%203%20ref%20"
                        + month
                        + "-"
                        + year
                        + ".ods"
            ...
            # Não possue link para o mês 09 porque a tabela de remunerações mensais não está disponibilizada. O link encaminha para tabela de verbas indenizatórias
                ...
                if month in ["01", "02", "03", "04", "05", "06", "07"]:
                    ...
                    link = (
                        baseURL
                        + "verbas_indeniz/verb_ind_serv/verb_ind_serv_ativos/Servidores%20Ativos%20tabela%203%20ref%20"
                        + month
                        + "-"
                        + year
                        + ".ods"
                ...
                if month in ["08", "09", "12"]:
                    ...
                    link = (
                        baseURL
                        + "verbas_indeniz/verb_ind_serv/verb_ind_serv_inativos/Servidores%20Inativos%20tabela%203%20ref%20"
                        + month
                        + "-"
                        + year
                        + ".ods"
