...
# Saídas esperadas utilizando apenas uma pessoa de cada grupo
...
class TestParser(unittest.TestCase):
    ...
    def test_membros_ativos(self):
        ...
        membros_ativos= parser.crawler_result(YEAR, MONTH, file_names_membros_ativos)['employees']
    ...
    def test_membros_inativos(self):
        ...
        membros_inativos = parser.crawler_result(YEAR, MONTH, file_names_membros_inativos)['employees']
    ...
    def test_servidores_ativos(self):
        ...
        servidores_ativos = parser.crawler_result(YEAR, MONTH, file_names_servidores_ativos)['employees']
    ...
    def test_servidores_inativos(self):
        ...
        servidores_inativos = parser.crawler_result(YEAR, MONTH, file_names_servidores_inativos)['employees']
    ...
    def test_pensionistas(self):
        ...
        pensionistas = parser.crawler_result(YEAR, MONTH, file_names_pensionistas)['employees']
    ...
    def test_colaboradores(self):
        ...
        colaboradores = parser.crawler_result(YEAR, MONTH, file_names_colaboradores)['employees']
